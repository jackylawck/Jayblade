// 配件資料庫 (去名稱化，僅保留型號與物理特性)
const PARTS_DATABASE = {
  crowns: {
    'wizard_arc':   { name: 'UX-03 (外環慣量 / 持久天花板)', mass: 37, radius: 29.5, weightDist: 0.98, restitution: 0.45, liftAngle: 0.0, burstResist: 0.85, attackPower: 1.0, color: '#f1c40f' },
    'phoenix_wing': { name: 'BX-23 (重量壓制 / 強烈對撞)', mass: 48, radius: 28.0, weightDist: 0.65, restitution: 0.95, liftAngle: 0.1, burstResist: 0.90, attackPower: 1.8, color: '#e74c3c' },
    'shark_scale':  { name: 'UX-15 (低位剷飛 / 極限爆發)', mass: 39, radius: 27.5, weightDist: 0.55, restitution: 0.90, liftAngle: 0.45, burstResist: 0.70, attackPower: 2.2, color: '#3498db' },
    'dran_buster':  { name: 'UX-17 (偏心重擊 / 爆發衝撞)', mass: 42, radius: 28.5, weightDist: 0.70, restitution: 0.85, liftAngle: 0.2, burstResist: 0.75, attackPower: 1.9, color: '#9b59b6' },
    'knight_shield':{ name: 'BX-04 (流線防禦 / 減震護盾)', mass: 41, radius: 29.0, weightDist: 0.85, restitution: 0.50, liftAngle: 0.0, burstResist: 0.95, attackPower: 0.8, color: '#a29bfe' }
  },
  tips: {
